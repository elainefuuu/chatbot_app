...
def get_context_retrieval(vector_store):
    llm = ChatOpenAI()
...
def get_vectorstore_from_url(website_url):
    ...
    documents_chunks = text_splitter.split_documents(loader.load())
...
def get_response(user_input):
    retriever_chain = get_context_retrieval(st.session_state.vector_store)
...
# app config
st.set_page_config(
    page_title="Chat with website", page_icon=":robot:"
)
...
if website_url is None or website_url == "":
    st.info("Please enter a website URL on the sidebar.")
